  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "3xl": ["36px", { lineHeight: "44px", letterSpacing: "-0.3px" }],
        "4xl": ["42px", { lineHeight: "48px", letterSpacing: "-0.4px" }],
        "5xl": ["56px", { lineHeight: "64px", letterSpacing: "-0.5px" }],
        "6xl": ["72px", { lineHeight: "80px", letterSpacing: "-0.5px" }],
        "7xl": ["84px", { lineHeight: "92px", letterSpacing: "-0.6px" }],
      },
      keyframes: {
        "accordion-down": {
          from: {
