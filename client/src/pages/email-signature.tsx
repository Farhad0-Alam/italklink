...
<table cellpadding="0" cellspacing="0" border="0" style="font-family: Arial, sans-serif; max-width: 700px; margin: 0; padding: 0; background-color: #f9f9f9;">
  ...
  const getSocialIconSVG = (platform: string): string => {
    const icons: Record<string, string> = {
      ...
      instagram: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAOElEQVR42mNgGAWjYBSMglEwCkYBFPD5//8/AwMDAwMDA8P/////MzAwMPz9+5eBgYGBgYGBgZHhPwMDAwMDAwMDAwOD/ysIAABZJ4AEBZpDfwAAAABJRU5ErkJggg==",
      twitter: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAOElEQVR42mNgGAWjYBSMglEwCkYBFPD5//8/AwMDAwMDA8P/////MzAwMPz9+5eBgYGBgYGBgZHhPwMDAwMDAwMDAwOD/ysIAABZJ4AEBZpDfwAAAABJRU5ErkJggg==",
      youtube: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAOElEQVR42mNgGAWjYBSMglEwCkYBFPD5//8/AwMDAwMDA8P/////MzAwMPz9+5eBgYGBgYGBgZHhPwMDAwMDAwMDAwOD/ysIAABZJ4AEBZpDfwAAAABJRU5ErkJggg==",
