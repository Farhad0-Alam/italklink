        ...
        <tr>
          ...
          <td style="vertical-align: top; padding-top: 2px;">
            <table cellpadding="0" cellspacing="0" border="0">
              ...
              ${cellPhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding-bottom: 0px;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${phoneIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> ${cellPhone}</td></tr>` : ""}
              ${email ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding-bottom: 2px;"><a href="mailto:${email}" style="color: ${contactInfoColor}; text-decoration: none;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${emailIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> ${email}</a></td></tr>` : ""}
              ${website ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding-bottom: 2px;"><a href="${website}" style="color: ${contactInfoColor}; text-decoration: none;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${websiteIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> ${website}</a></td></tr>` : ""}
              ${customFieldsHTML}
        ...
        <tr>
          ...
          <td style="vertical-align: top; border-left: 3px solid ${primaryColor}; padding-left: 20px;">
            <table cellpadding="0" cellspacing="0" border="0">
              ...
              ${cellPhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding: 2px 0;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${phoneIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> <a href="tel:${cellPhone}" style="color: ${contactInfoColor}; text-decoration: none;">${cellPhone}</a></td></tr>` : ""}
              ${officePhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding: 2px 0;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${phoneIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> <a href="tel:${officePhone}" style="color: ${contactInfoColor}; text-decoration: none;">${officePhone}</a></td></tr>` : ""}
              ${email ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding: 2px 0;"><a href="mailto:${email}" style="color: ${contactInfoColor}; text-decoration: none;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${emailIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> ${email}</a></td></tr>` : ""}
              ${website ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding: 2px 0;"><a href="${website}" style="color: ${contactInfoColor}; text-decoration: none;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${websiteIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> ${website}</a></td></tr>` : ""}
        ...
        <tr>
          ...
          <td style="vertical-align: top;">
            <table cellpadding="0" cellspacing="0" border="0">
              ...
              ${cellPhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding: 2px 0;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${phoneIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> <a href="tel:${cellPhone}" style="color: ${contactInfoColor}; text-decoration: none; font-weight: 500;">${cellPhone}</a></td></tr>` : ""}
              ${officePhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding: 2px 0;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${phoneIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> <a href="tel:${officePhone}" style="color: ${contactInfoColor}; text-decoration: none; font-weight: 500;">${officePhone}</a></td></tr>` : ""}
              ${email ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding: 2px 0;"><a href="mailto:${email}" style="color: ${contactInfoColor}; text-decoration: none; font-weight: 500;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${emailIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> ${email}</a></td></tr>` : ""}
              ${website ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding: 2px 0;"><a href="${website}" style="color: ${contactInfoColor}; text-decoration: none; font-weight: 500;"><span style="display:inline-block;background-color:${contactIconColor};padding:2px;"><img src="${websiteIcon}" alt="icon" style="border:none; width:13px; height:13px;"></span> ${website}</a></td></tr>` : ""}
              ${address ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${Math.round(contactInfoSize * 0.9)}px; color: ${contactInfoColor}; opacity: 0.8; padding: 2px 0;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">📍</span> ${address}</td></tr>` : ""}
              ${customFieldsHTML}
