...
export default function EmailSignature() {
  ...
  const [signatureData, setSignatureData] = useState<SignatureData>({
    ...
    verticalDividerLeftPadding: 21,
    verticalDividerLeftGap: 2,
    socialLinks: [
      {
        platform: "linkedin",
    ...
    ctaButtonBorderStyle: "solid",
    ctaButtonFont: "Arial",
    ctaButtonFontSize: 19,
...
<table cellpadding="0" cellspacing="0" border="0" style="font-family: Arial, sans-serif; max-width: 400px; margin: 0; padding: 0; table-layout: fixed; width: 100%;">
  ...
  const generateTemplate2 = (): string => {
    const {
      ...
      ctaButtonBorderColor, ctaButtonBorderWidth, ctaButtonBorderStyle, ctaButtonFont, ctaButtonFontSize, ctaButtonFontColor, ctaButtonGroupAlignment,
        ...
        <div className="grid gap-4" style={{ gridTemplateColumns: "30% 70%" }}>
          <div className="space-y-2">
                            ...
                            <div className="border-t pt-3">
                              ...
                              <div className="space-y-2">
                                ...
                                <div>
                                  <Label className="text-xs">Border Style</Label>
                                  <select
                                    value={signatureData.ctaButtonBorderStyle}
                                    onChange={(e) => updateField("ctaButtonBorderStyle", e.target.value)}
                                    className="w-full px-2 py-1 border rounded text-xs"
                                    data-testid="select-cta-border-style"
                                  >
            ...
            <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <CardHeader
                className="cursor-pointer py-2 px-3"
                onClick={() => toggleSection("disclaimerSection")}
                data-testid="toggle-disclaimer-section"
              >
                <div className="flex items-center justify-between">
                  <CardTitle className="text-sm font-semibold text-slate-900 dark:text-white">
                    Disclaimer
                  </CardTitle>
                  {collapsedSections.disclaimerSection ? (
                    <ChevronDown className="w-4 h-4" />
                  ) : (
                    <ChevronUp className="w-4 h-4" />
                  )}
                ...
                {!collapsedSections.disclaimerSection && (
                  <>
                    ...
                    {signatureData.showDisclaimer && (
                      <>
                        <div className="border-t pt-3 mt-3">
                          <Label className="text-xs font-semibold">Disclaimer Text</Label>
                          <Textarea
                        ...
                        <div className="border-t pt-3 mt-3 space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(v) =>
                              updateField("disclaimerFont", v)
                            }
                          >
                            <SelectTrigger
                              className="w-full"
                              data-testid="select-disclaimer-font"
                            >
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            ...
                            <input
                              ...
                              className="custom-range w-full"
                              data-testid="slider-disclaimer-font-size"
                            />
                          </div>
                          <div>
                            ...
                            <Select
                              ...
                              onValueChange={(v: any) =>
                                updateField("disclaimerTextAlign", v)
                              }
                            >
                              <SelectTrigger
                                className="w-full"
                                data-testid="select-disclaimer-text-align"
                              >
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                        ...
                        <div>
                          <Label className="text-xs mb-1">Font Color</Label>
                          <div className="flex gap-2">
                            <input
                              type="color"
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div className="flex items-center justify-between">
                            ...
                            <Switch
                              ...
                              onCheckedChange={(checked) =>
                                updateField("disclaimerBold", checked)
                              }
                              data-testid="switch-disclaimer-bold"
                            />
                          </div>
                          <div className="flex items-center justify-between">
                            ...
                            <Switch
                              ...
                              onCheckedChange={(checked) =>
                                updateField("disclaimerItalic", checked)
                              }
                              data-testid="switch-disclaimer-italic"
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="custom-range w-full"
                            data-testid="slider-disclaimer-top-spacing"
                          />
                        </div>
                      </>
                    )}
