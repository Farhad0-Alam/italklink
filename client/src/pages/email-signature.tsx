...
export default function EmailSignature() {
  ...
  const [signatureData, setSignatureData] = useState<SignatureData>({
    ...
    socialLinks: [
      { platform: 'linkedin', url: 'https://linkedin.com/in/johndoe', icon: 'SiLinkedin' },
      { platform: 'twitter', url: 'https://twitter.com/johndoe', icon: 'SiX' },
      { platform: 'facebook', url: 'https://facebook.com/johndoe', icon: 'SiFacebook' }
    ],
        ...
        <tr>
          ...
          <td style="vertical-align: top; padding-top: 5px;">
            <table cellpadding="0" cellspacing="0" border="0">
              ...
              <tr>
                <td style="font-family: Arial, sans-serif; font-size: ${nameSize}px; font-weight: bold; color: ${nameColor}; padding-bottom: 5px;">${name}</td>
              </tr>
              ${title ? `<tr><td style="font-family: Arial, sans-serif; font-size: ${titleSize}px; color: ${titleColor}; padding-bottom: 3px;">${title}</td></tr>` : ''}
              ...
              ${cellPhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding-bottom: 3px;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">📱</span> ${cellPhone}</td></tr>` : ''}
              ${email ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding-bottom: 3px;"><a href="mailto:${email}" style="color: ${contactInfoColor}; text-decoration: none;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">✉️</span> ${email}</a></td></tr>` : ''}
              ${website ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding-bottom: 8px;"><a href="${website}" style="color: ${primaryColor}; text-decoration: none;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">🌐</span> ${website}</a></td></tr>` : ''}
              ${customFieldsHTML}
        ...
        <tr>
          ...
          <td style="vertical-align: top; border-left: 3px solid ${primaryColor}; padding-left: 20px;">
            <table cellpadding="0" cellspacing="0" border="0">
              ...
              ${title ? `<tr><td style="font-family: Arial, sans-serif; font-size: ${titleSize}px; color: ${titleColor}; padding-bottom: ${company ? '3px' : '10px'};">${title}</td></tr>` : ''}
              ${company ? `<tr><td style="font-family: Arial, sans-serif; font-size: ${companySize}px; color: ${companyColor}; padding-bottom: 10px;">${company}</td></tr>` : ''}
              ${cellPhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding: 3px 0;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">📱</span> <a href="tel:${cellPhone}" style="color: ${contactInfoColor}; text-decoration: none;">${cellPhone}</a></td></tr>` : ''}
              ${officePhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding: 3px 0;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">☎️</span> <a href="tel:${officePhone}" style="color: ${contactInfoColor}; text-decoration: none;">${officePhone}</a></td></tr>` : ''}
              ${email ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding: 3px 0;"><a href="mailto:${email}" style="color: ${contactInfoColor}; text-decoration: none;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">✉️</span> ${email}</a></td></tr>` : ''}
              ${website ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding: 3px 0;"><a href="${website}" style="color: ${primaryColor}; text-decoration: none;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">🌐</span> ${website}</a></td></tr>` : ''}
              ${address ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${Math.round(contactInfoSize * 0.9)}px; color: ${contactInfoColor}; opacity: 0.8; padding: 5px 0;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">📍</span> ${address}</td></tr>` : ''}
              ${customFieldsHTML}
        ...
        <tr>
          ...
          <td style="vertical-align: top;">
            <table cellpadding="0" cellspacing="0" border="0">
              ...
              ${title ? `<tr><td style="font-family: Arial, sans-serif; font-size: ${titleSize}px; color: ${titleColor}; font-weight: 600; padding-bottom: 3px;">${title}</td></tr>` : ''}
              ...
              ${cellPhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding: 5px 0;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">📱</span> <a href="tel:${cellPhone}" style="color: ${contactInfoColor}; text-decoration: none; font-weight: 500;">${cellPhone}</a></td></tr>` : ''}
              ${officePhone ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; color: ${contactInfoColor}; padding: 5px 0;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">☎️</span> <a href="tel:${officePhone}" style="color: ${contactInfoColor}; text-decoration: none; font-weight: 500;">${officePhone}</a></td></tr>` : ''}
              ${email ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding: 5px 0;"><a href="mailto:${email}" style="color: ${primaryColor}; text-decoration: none; font-weight: 500;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">✉️</span> ${email}</a></td></tr>` : ''}
              ${website ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${contactInfoSize}px; padding: 5px 0;"><a href="${website}" style="color: ${primaryColor}; text-decoration: none; font-weight: 500;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">🌐</span> ${website}</a></td></tr>` : ''}
              ${address ? `<tr><td style="font-family: ${contactFont}, sans-serif; font-size: ${Math.round(contactInfoSize * 0.9)}px; color: ${contactInfoColor}; opacity: 0.8; padding: 5px 0;"><span style="color: ${contactIconColor}; font-size: ${contactIconSize}px;">📍</span> ${address}</td></tr>` : ''}
              ${customFieldsHTML}
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Email Signature Generator</h1>
            <p className="text-slate-600 dark:text-slate-400">Create professional email signatures in minutes</p>
          </div>
        </div>

        <Tabs value={templateType} onValueChange={(v) => setTemplateType(v as 'simple' | 'advanced' | 'premium')} className="mb-6">
          <TabsList className="grid w-full grid-cols-3 max-w-md" data-testid="tabs-template-type">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              ...
              >
                <div className="flex items-center justify-between">
                  <CardTitle className="text-slate-900 dark:text-white">Signature (Handwritten Style)</CardTitle>
                  {collapsedSections.signatureSection ? <ChevronDown className="w-5 h-5" /> : <ChevronUp className="w-5 h-5" />}
                </div>
              </CardHeader>
            ...
            <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              ...
              >
                <div className="flex items-center justify-between">
                  <CardTitle className="text-slate-900 dark:text-white">Name/Title/Company</CardTitle>
                  {collapsedSections.nameSection ? <ChevronDown className="w-5 h-5" /> : <ChevronUp className="w-5 h-5" />}
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                ...
                {!collapsedSections.nameSection && (
                  <div className="space-y-3 pt-3">
                    ...
                    <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3">
                      ...
                      >
                        <Label className="text-sm font-semibold">Name Style</Label>
                        {collapsedSections.nameStyle ? <ChevronDown className="w-4 h-4" /> : <ChevronUp className="w-4 h-4" />}
                      </div>
                      {!collapsedSections.nameStyle && (
                        <div className="space-y-3">
                          ...
                          <div>
                            <Label className="text-xs">Size: {signatureData.nameSize}px</Label>
                            <input
                              type="range"
                              min="10"
                              max="48"
                              value={signatureData.nameSize}
                              onChange={(e) => updateField('nameSize', parseInt(e.target.value))}
                              className="custom-range w-full"
                    ...
                    <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3">
                      ...
                      >
                        ...
                        {collapsedSections.titleStyle ? <ChevronDown className="w-4 h-4" /> : <ChevronUp className="w-4 h-4" />}
                      </div>
                      {!collapsedSections.titleStyle && (
                        <div className="space-y-3">
                          ...
                          <div>
                            <Label className="text-xs">Size: {signatureData.titleSize}px</Label>
                            <input
                              type="range"
                              min="10"
                              max="32"
                    ...
                    <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3">
                      ...
                      >
                        ...
                        {collapsedSections.companyStyle ? <ChevronDown className="w-4 h-4" /> : <ChevronUp className="w-4 h-4" />}
                      </div>
                      {!collapsedSections.companyStyle && (
                        <div className="space-y-3">
                          ...
                          <div>
                            <Label className="text-xs">Size: {signatureData.companySize}px</Label>
                            <input
                              type="range"
                              min="10"
                              max="32"
                              value={signatureData.companySize}
                              onChange={(e) => updateField('companySize', parseInt(e.target.value))}
                              className="custom-range w-full"
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              <Input
                                ...
                                onChange={(e) => updateField('companyColor', e.target.value)}
                                className="w-16 h-9"
            ...
            <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {collapsedSections.contactSection ? <ChevronDown className="w-5 h-5" /> : <ChevronUp className="w-5 h-5" />}
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3 pt-4 border-t">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">Add any additional information like LinkedIn, Skype, Department, etc.</p>
                </div>
                ...
                {!collapsedSections.contactSection && (
                  <div className="space-y-3 pt-3">
                    ...
                    <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3">
                      ...
                      >
                        <Label className="text-sm font-semibold">Contact Info Style</Label>
                        {collapsedSections.contactInfoStyle ? <ChevronDown className="w-4 h-4" /> : <ChevronUp className="w-4 h-4" />}
                      </div>
                      {!collapsedSections.contactInfoStyle && (
                        <div className="space-y-3">
                          ...
                          <div>
                            <Label className="text-xs">Size: {signatureData.contactInfoSize}px</Label>
                            <input
                              type="range"
                              min="10"
                              max="24"
                    ...
                    <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3">
                      ...
                      >
                        <Label className="text-sm font-semibold">Contact Info Icon Style</Label>
                        {collapsedSections.contactIconStyle ? <ChevronDown className="w-4 h-4" /> : <ChevronUp className="w-4 h-4" />}
                      </div>
                      {!collapsedSections.contactIconStyle && (
                        <div className="space-y-3">
                          <div>
                            <Label className="text-xs">Icon Size: {signatureData.contactIconSize}px</Label>
                            <input
                              type="range"
                              min="12"
                              max="32"
                              value={signatureData.contactIconSize}
                              onChange={(e) => updateField('contactIconSize', parseInt(e.target.value))}
                              className="custom-range w-full"
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              <Input
                                ...
                                onChange={(e) => updateField('contactIconColor', e.target.value)}
                                className="w-16 h-9"
            ...
            <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <CardHeader>
                <CardTitle className="text-slate-900 dark:text-white">Images</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
            ...
            <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <CardHeader>
                <CardTitle className="text-slate-900 dark:text-white">Brand Colors</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
            ...
            <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-slate-900 dark:text-white">Social Links</CardTitle>
                  <Button
                    type="button"
                    size="sm"
                    variant="outline"
              ...
              <CardContent className="space-y-3">
                {signatureData.socialLinks.map((link, index) => (
                  <div key={index} className="flex gap-2">
                    ...
                    >
                      <SelectTrigger className="w-40" data-testid={`select-social-platform-${index}`}>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                {signatureData.socialLinks.length === 0 && (
                  <p className="text-sm text-slate-500 dark:text-slate-400 text-center py-4">No social links added yet</p>
                )}
              </CardContent>
            </Card>
            ...
            {templateType !== 'simple' && (
              <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                <CardHeader>
                  <CardTitle className="text-slate-900 dark:text-white">Optional Features</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
            ...
            <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 sticky top-4">
              ...
              <CardContent>
                ...
                <div className="flex gap-2 mt-4">
                  <Button onClick={copyToClipboard} className="flex-1 gap-2" data-testid="button-copy">
                    <Copy className="w-4 h-4" />
                    Copy HTML
                  </Button>
                  <Button onClick={downloadHTML} variant="outline" className="flex-1 gap-2" data-testid="button-download">
                    <Download className="w-4 h-4" />
                    Download
                  </Button>
                </div>

                <Button onClick={previewInEmail} variant="secondary" className="w-full mt-2 gap-2" data-testid="button-preview-email">
