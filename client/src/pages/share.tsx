...
export const Share: React.FC = () => {
      ...
      <div className="min-h-screen bg-slate-900 text-slate-50 flex items-center justify-center">
        <Card className="bg-slate-800 border-slate-700 max-w-md mx-4">
          <CardContent className="pt-6 text-center">
            ...
            >
              <a href="https://talkl.ink/">Create Your Own Card</a>
            </Button>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="fixed inset-0 bg-slate-900 text-slate-50 overflow-y-auto">
      ...
      <div className="w-full max-w-[430px] md:max-w-[380px] mx-auto px-0 py-0 min-h-screen">
        {/* Premium Mobile Card Layout - Mobile: 390-430px responsive range, Desktop: 380px fixed width, centered, true edge-to-edge */}
