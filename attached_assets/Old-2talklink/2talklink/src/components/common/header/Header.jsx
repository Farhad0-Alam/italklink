      ...
      >
        <div className="pu_container" ref={headerContainer}>
          <div className={styles.header_inner}>
            <Link
              href={tokenData?.role === 2 ? "/dashboard" : "/admin/dashboard"}
            >
                      ...
                      <>
                        <li>
                          <Link href="/admin/dashboard">
                            <a className={isActive("/admin/dashboard")}>
                              Dashboard
                            </a>
                          </Link>
                        </li>
                        ...
                        <li>
                          <Link href="/admin/template-categories">
                            <a
                              className={isActive("/admin/template-categories")}
                            >
                              Categories
                            </a>
                          </Link>
                          ...
                          <ul>
                            <li>
                              <Link href="/admin/plans">
                                <a className={isActive("/admin/plans")}>
                                  All Plans
                                </a>
                              </Link>
                            </li>
                            <li>
                              <Link href="/admin/coupons">
                                <a className={isActive("/admin/coupons")}>
                                  Coupons
                                </a>
                              </Link>
                            </li>
                        ...
                        <li>
                          <Link href="/admin/templates">
                            <a className={isActive("/admin/templates")}>
                              Templates
                            </a>
                          </Link>
                        </li>
                          ...
                          <ul>
                            ...
                            <li>
                              <Link href="/admin/icontype">
                                <a className={isActive("/admin/icontype")}>
                                  Icon Type
                                </a>
                              </Link>
                            </li>
                            <li>
                              <Link href="/admin/iconpack">
                                <a className={isActive("/admin/iconpack")}>
                                  Icon Pack
                                </a>
                              </Link>
                            </li>
                    ...
                    >
                      ...
                      <ul>
                        <li>
                          ...
                          >
                            <a className="pu_dropdown_link">Profile & Plan</a>
                          </Link>
                        </li>
                        {tokenData?.role === 1 ? (
                          <li>
                            <Link href={"/admin/settings"}>
                              <a className="pu_dropdown_link">
                                Payment Settings
                              </a>
                            </Link>
                            <Link href={"/admin/emailSettings"}>
                              <a className="pu_dropdown_link">Email Settings</a>
                            </Link>
                          </li>
                        ) : (
                          ""
