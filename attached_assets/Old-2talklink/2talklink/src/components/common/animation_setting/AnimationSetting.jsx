    ...
    <div className={styles.seo_wrapper}>
      <div className={styles.seo_pagelist_wrapper}>
        ...
        <div className={styles.element_wrapper_outer}>
          {data.map((ele) => (
            <div
              className={`${styles.element_wrap} ${
                activeElement._id == ele._id && styles.activeElement
              }`}
              key={ele._id}
            ...
            >
              <div className={styles.element_icon_box}>
                {ele.type === "el_link"
                  ? svg["icon_" + `el_${ele?.sectionData?.type}`]
                  : svg["icon_" + ele.type]}
              </div>
              <div
                className={styles.element_section_title}
                style={{ textTransform: "capitalize" }}
              >
                {ele?.sectionData?.type || ele?.title}
              </div>
            </div>
          ))}
        </div>
