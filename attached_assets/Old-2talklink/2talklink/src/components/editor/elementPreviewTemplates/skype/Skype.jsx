...
import styles from "./Skype.module.css";
const SkypeElement = (props) => {
    ...
    //         link_url: url,
    //     };
    //     if (props.item.sectionData.type === "phone") {
    //         window.open(
    //             url,
    //             props.item.sectionData.openNewTab ? "_blank" : "_self"
    //         );
    //     } else {
        ...
        return (
            <>
                <div
                    ...
                    {props.item.sectionData.type === "phone" ? (
                        <>
                            <a
                                href={`skype:${props.item.sectionData.phone}?chat`}
                    ...
                    {props.item.sectionData.type === "phone" ? (
                        <>
                            <a
                                ...
                                style={{
                                    boxShadow:
                                        "0px 4px 12px" + props.primaryColor,
                ...
                <div
                    ...
                    {props.item.sectionData.type === "phone" ? (
                        <>
                            ...
                            <span
                                className={styles.link_bg}
                                style={{ color: props.primaryColor }}></span>
                        </>
                    ) : (
                        <>
                            <div>
                    ...
                    {props.item.sectionData.type === "phone" ? (
                        <>
                            <a
                                ...
                                <span>{props.item.sectionData.title}</span>
                            </a>
                        </>
                    ) : (
                        <>
            ...
            <>
                <div
                    ...
                    {props.item.sectionData.type === "phone" ? (
                        ...
                        <div style={{ color: props.secondaryColor }}>
                            <a
                                href={`skype:${props.item.sectionData.phone}?chat`}
                                rel="noopener noreferrer"
                                style={{
