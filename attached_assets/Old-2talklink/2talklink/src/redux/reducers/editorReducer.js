  ...
  switch (action.type) {
    ...
    case "DELETE_SECTION":
      ...
      state6 = {
        ...state6,
        sectionList: [
          ...state6.sectionList.filter((item) => item._id !== action.payload),
        ],
      };
      return state6;
    ...
    case "CHANGE_TEMPLATE":
      ...
      return state12;
    case "ADD_AND_REMOVE_IMAGE_FOR_IMAGE_SLIDER": {
      let state13 = { ...state };
      state13.sectionList = state13.sectionList.map((list) => {
    ...
    // case "REMOVE_IMAGE_FOR_IMAGE_SLIDER": {
    //   let state14 = { ...state };
    //   // state14.sectionList = state14.sectionList.filter(
