...
const Dashboard = () => {
  ...
  useEffect(() => {
    dispatch(
      setPageHeading({
        pageHeading: "2TalkLink - Dashboard",
        title: "2TalkLink - Dashboard",
      })
    );
  }, [dispatch]);
    ...
    <div className="pu_container">
      ...
      <div className="pu_analytics_white_box_list">
        <div className="pu_analytics_white_box">
          <div className="pu_awb_icon">{svg.analysis_click}</div>
        ...
        <div className="pu_analytics_white_box">
          <div className="pu_awb_icon">{svg.analysis_weekly_visitor}</div>
          <div className="pu_awb_details">
            <h3>{weeklyVisitor}</h3>
            <p>Weekly Visitor</p>
          </div>
        ...
        <div className="pu_analytics_white_box">
          <div className="pu_awb_icon">{svg.analysis_monthly_visitor}</div>
          <div className="pu_awb_details">
        ...
        <div className="pu_analytics_white_box">
          <div className="pu_awb_icon">{svg.analysis_links}</div>
          <div className="pu_awb_details">
            <h3>{linkCount}</h3>
            <p>Created Links</p>
          </div>
      ...
      <div className={styles.create_link_header}>
        ...
        <Link href="/templates">
          <a className="pu_btn pu_btn_add">
            {svg.btn_add_icon} Create New Link
          </a>
        </Link>
        {/* <CreateLink>
