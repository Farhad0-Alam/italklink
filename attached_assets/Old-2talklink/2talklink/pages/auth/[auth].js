...
const Auth = (props) => {
    ...
    let authTitle = '';
    if (authType === 'login') {
        authTitle = '2TalkLink - Login'
    } else if (authType === 'registration') {
        authTitle = '2TalkLink - SignUp'
    } else if (authType === 'forgot-password') {
        authTitle = '2TalkLink - Forgot Password'
    }
            ...
            <div className={styles.auth_wrapper}>
                <div className={styles.auth_header}>
                    <div className={styles.auth_header_logo}>
                        <Link href="/"><a><img src="/images/2TalkLink-Logo.png" width="150px" /></a></Link>
                    </div>
                </div>
                        ...
                        <form onSubmit={(e) => onFormSubmit(e, authType)}>
                            {
                                authType == 'registration' ?
                                    <>
                                        {!isVerify ?
                                            <>
                                                <h3>Let’s Started with <span>2TalkLink.</span></h3>
                                    ...
                                    : (authType == 'forgot-password' ?
                                        ...
                                        <>
                                            <h3>Welcome Back to <span>2TalkLink</span></h3>
                                            <p>Connect and manage all your social links at one place</p>
                                            <div className={styles.auth_input_wrapper}>
