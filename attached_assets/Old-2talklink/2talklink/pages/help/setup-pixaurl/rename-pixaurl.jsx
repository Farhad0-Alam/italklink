...
const renamePixaurl = () => {
    ...
    <>  
            <div className={styles.page_full_handle}>
                <div className="pu_container">
                    <div className={styles.pu_wr}>
                        <h3 className={styles.page_heading}>Rename 2TalkLink </h3>
            ...
            <div className="pu_container">
                <div>
                    <p>rename pixaurl is simply dummy text of the printing and typesetting industry.
