...
export const contactSectionElementSchema = baseElementSchema.extend({
  ...
  data: z.object({
    ...
    // Container Styling
    containerBackground: z.string().optional().default("#ffffff"),
    containerBorderColor: z.string().optional().default("#e5e7eb"),
    containerBorderWidth: z.number().optional().default(1),
    containerBorderRadius: z.number().optional().default(8),
    containerPadding: z.number().optional().default(16),
    gap: z.number().optional(),
    enableContainerStyling: z.boolean().optional().default(false),
    applyContainerToEachIcon: z.boolean().optional().default(false),
    containerWidth: z.string().optional().default("100%"),
    containerHeight: z.string().optional().default("auto"),
    enableContainerShadow: z.boolean().optional().default(false),
    containerShadowColor: z.string().optional().default("#000000"),
    containerShadowOpacity: z.number().optional().default(10),
    containerShadowBlur: z.number().optional().default(10),
    containerShadowOffsetX: z.number().optional().default(0),
    containerShadowOffsetY: z.number().optional().default(4),
  }),
});
