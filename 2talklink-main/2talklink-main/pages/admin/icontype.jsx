                ...
                <form onSubmit={addIconTypeFormSubmit}>
                    ...
                    <div className="pu_input_wrapper">
                        ...
                        <div className="pu_radio_list">
                            ...
                            <div className="pu_radio">
                                <input type="radio" name="social_type" id="type_whatsapp" value="whatsapp" defaultChecked={type === 'whatsapp' ? true : false} onChange={(e) => setType(e.target.value)} />
                                <label htmlFor="type_whatsapp">WhatsApp</label>
                            </div>
                            <div className="pu_radio">
                                <input type="radio" name="social_type" id="type_text" value="text" defaultChecked={type === 'text' ? true : false} onChange={(e) => setType(e.target.value)} />
                                <label htmlFor="type_text">Text</label>
                            </div>
                            <div className="pu_radio">
                                <input type="radio" name="social_type" id="type_connect" value="connect" defaultChecked={type === 'connect' ? true : false} onChange={(e) => setType(e.target.value)} />
                                <label htmlFor="type_connect">Connect</label>
                            </div>
                        </div>
                    </div>
                    <div className="pu_input_wrapper">
