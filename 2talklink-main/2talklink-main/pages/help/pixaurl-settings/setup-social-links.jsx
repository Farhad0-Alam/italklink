...
const setupSociallinks = () => {
    return (
            <>  
                <div className={styles.page_full_handle}>
                    <div className="pu_container">
                        <div className={styles.pu_wr}>
                            <h3 className={styles.page_heading}>Setup Social Links</h3>
                ...
                <div className="pu_container">
                    <div>
                        <p>setup social links is simply dummy text of the printing and typesetting industry.
