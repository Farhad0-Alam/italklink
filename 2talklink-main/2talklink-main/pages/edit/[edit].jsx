...
const Editor = (props) => {
            ...
            common.getAPI(
                ...
                (resp) => {
                    if (resp.status === "success") {
                        dispatch(
                            setPageHeading({
                                pageHeading: "2TalkLink - " + resp.data.title,
                                title: "2TalkLink - " + resp.data.title,
                            })
                        );
                        ...
                        common.getAPI(
                            ...
                            (resp) => {
                                if (resp.status === "success") {
                                    ...
                                    dispatch(
                                        contentPlaceholder({ pages: false })
                                    );
    ...
    return (
        <>
            <div
                className="pu_tab_nav pu_tab_nav_editor_mobile"
                style={{ display: "none" }}>
                <ul>
                    <li
                        className={
            ...
            <div
                className={styles.mobile_header_action}
                style={{ display: "none" }}>
                <a
                    className={
                        "pu_back_arrow " + styles.pu_back_arrow_editor_mobile
                    }>
            ...
            <div className={styles.editor_wrapper}>
                ...
                <div className={styles.editor_body} style={{position:"relative"}}>
