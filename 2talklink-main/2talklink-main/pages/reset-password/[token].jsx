...
const ResetPassword = () => {
    ...
    const onFormSubmit = async (e, submitType) => {
        ...
        const emptycpassword = validator.isEmpty(cpassword, {
            ignore_whitespace: true,
        });
    ...
    return (
        <>
            <Head>
                <title>2TalkLink - Reset Password</title>
                <meta
            ...
            <div className={styles.auth_bg}>
                <span
                    className={
                        styles.auth_bg_circle + " " + styles.auth_bg_circle_1
                    }></span>
                <span
                    className={
                        styles.auth_bg_circle + " " + styles.auth_bg_circle_2
                    }></span>
                <span
                    className={
                        styles.auth_bg_circle + " " + styles.auth_bg_circle_3
                    }></span>
            </div>
