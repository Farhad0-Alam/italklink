...
const Templates = () => {
  ...
  useEffect(() => {
    dispatch(
      setPageHeading({
        pageHeading: "2TalkLink - " + pageTitle,
        title: "2TalkLink - " + pageTitle,
      })
    );
  }, [dispatch]);
      ...
      <div className="pu_container">
        <div className="pu_pagetitle_wrapper">
          ...
          <div className="pu_pagetitle_right">
            ...
            <div
              className={"pu_dropdown_wrapper " + styles.filter_toggle_wrapper}
            >
              <div
                className={"pu_dropdown_toggle " + styles.filter_toggle}
              ...
              <div
                className={"pu_dropdown_dd " + styles.filter_toggle_dropdown}
              >
                <ul>
                  <li
                    className={
                      (filterCatId === "" ? styles.active : "") +
                      " " +
                      styles.filter_link
                    }
                  ...
                  {categoryList.map((category) => (
                    <li
                      key={category._id}
                      className={
                        (filterCatId === category._id ? styles.active : "") +
                        " " +
                        styles.filter_link
                      }
                      ...
                      <div className={styles.template_icon}>
                        ...
                        <div className={styles.template_overlay}>
                          <a
                            ...
                            href={"/preview/" + temp._id + "/home"}
                            target="_blank"
                            rel="noreferrer"
                          >
                            Preview
                          </a>
                          {userData?.role === 1 || selectedModels?.includes(temp._id) ? (
                            <button
                              className={styles.template_edit}
                              onClick={() => createLink(temp._id)}
                            >
                              Select
                            </button>
                          ) : (
