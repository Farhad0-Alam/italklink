...
const Paragraph = (props) => {
  ...
  return (
    <>
      <div
        className={
          styles[props.item.type] +
          " " +
          styles["para_themes_" + props.htmlId] +
          " " +
          (props.isEditorPreview === true ? styles.editor_para : "") +
          "  " +
      ...
      >
        <div className="rich-editor-style ql-editor">
          <div
            className="ql-snow"
            dangerouslySetInnerHTML={{ __html: props.item.sectionData.paragraph }}
          ></div>
        </div>
      </div>
    </>
