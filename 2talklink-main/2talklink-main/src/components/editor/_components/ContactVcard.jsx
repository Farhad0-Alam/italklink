...
export default function ContactVcard(props) {
  const { styles, secondaryColor, primaryColor } = props || {};
  const { handleVcard } = useVcard(props);
  ...
  return (
    <>
      ...
      >
        ...
        <span style={{ fontSize: "16px", color: templateStyle?.tertiary_color || "#fff" }}>
          Save Contacts
        </span>
      </button>
    </>
