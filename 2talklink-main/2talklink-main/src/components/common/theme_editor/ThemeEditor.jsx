...
const ThemeEditor = (props) => {
  ...
  useEffect(() => {
    ...
    if (props.data) {
      var themeEditorData =
        props.data.metaData !== undefined ? props.data.metaData : props.data;
      if (themeEditorData) {
        ...
        setTertiaryColor(themeEditorData?.tertiary_color);
        ...
        if (themeEditorData.headingfont) {
          ...
          let findFont = fontList.find(
            (item) => item.label === themeEditorData.headingfont
          );
        ...
        if (themeEditorData.textfont) {
          ...
          let findFont1 = fontList.find(
            (item) => item.label === themeEditorData.textfont
          );
  ...
  const colorPickerChange = (type, color) => {
    if (color.hex) {
      ...
      } else if (type === "tertiary_color") {
        setTertiaryColor(color.toString());
  ...
  const colorPickerComplete = (type, color) => {
    if (color.hex) {
      ...
      if (type === "bgcolor") {
        ...
        copyMetaData.tertiary_color = color.toString();
      } else if (type.includes("gradientcolorbg_")) {
        const colors = [...gradientColors];
  ...
  return (
    <>
      <div
        className={
          styles.theme_editor_wrapper +
          " " +
          (store.userData.role === 2 || router.pathname === "/settings/[id]"
            ? styles.theme_editor_user
            : "")
        }
      >
        <div className={styles.theme_editor_content}>
            ...
            <div className="pu_input_wrapper_list">
                ...
                <div className="pu_color_picker_wrapper">
                  ...
                  <div className="pu_color_picker_dropdown">
                    <SketchPicker
                      ...
                      onChange={(color) =>
                        colorPickerChange("primary_color", color)
                      }
              ...
              <div className="pu_input_wrapper">
                ...
                <div className="pu_color_picker_wrapper">
                  <div
                    className="pu_color_picker_toggle"
                    onClick={() => colorPickerOpener("secondary_color")}
                  >
                    <span className="pu_color_name">{secondaryColorSt}</span>
                    <span
                      className="pu_color_preview"
                      style={{ backgroundColor: secondaryColorSt }}
                    ></span>
                  </div>
                  <div className="pu_color_picker_dropdown">
                    <SketchPicker
                      ...
                      onChange={(color) =>
                        colorPickerChange("secondary_color", color)
                      }
                      onChangeComplete={(color) =>
                        colorPickerComplete("secondary_color", color)
                      }
                    />
                    <HuePicker
                      color={secondaryColorSt}
              ...
              <div className="pu_input_wrapper">
                ...
                <div className="pu_color_picker_wrapper">
                  <div
                    className="pu_color_picker_toggle"
                    onClick={() => colorPickerOpener("tertiary_color")}
                  >
                    <span className="pu_color_name">{tertiaryColor}</span>
                    <span
                      className="pu_color_preview"
                  ...
                  <div className="pu_color_picker_dropdown">
                    <SketchPicker
                      color={tertiaryColor}
                      onChange={(color) =>
                        colorPickerChange("tertiary_color", color)
                      }
                      onChangeComplete={(color) =>
                        colorPickerComplete("tertiary_color", color)
                      }
                    />
                    <HuePicker
                      color={tertiaryColor}
          ...
          <div className={styles.theme_editor_box}>
            ...
            <div className="pu_input_wrapper_list">
              <div className="pu_input_wrapper">
                ...
                <select
                  className="pu_input"
                  onChange={(e) => defaultGradientTypeChange(e, e.target.value)}
                  value={defaultGradientType}
                >
                ...
                <div className="pu_input_wrapper">
                  ...
                  <div className="pu_mui_slider">
                    <Slider
                      ...
                      onChange={(e) =>
                        defaultGradientAngleChange(e, e.target.value)
                      }
                      min={0}
                      max={360}
                    />
            ...
            <div className="pu_gradient_editor_wrapper">
              <div
                className="pu_input_wrapper_list"
                style={{
                ...
                <div key={index} className="pu_input_wrapper_list">
                  <div className="pu_input_wrapper">
                    <div className="pu_color_picker_wrapper">
                      <div
                        className="pu_color_picker_toggle"
                        onClick={() => colorPickerOpener("color1")}
                      >
                        <span className="pu_color_name">{gcolor.color}</span>
                        <span
                          className="pu_color_preview"
                          style={{ backgroundColor: gcolor.color }}
                        ></span>
                      </div>
                      <div className="pu_color_picker_dropdown">
                        <SketchPicker
                  ...
                  <div
                    className="pu_remove"
                    onClick={() => removeDefaultGradientColor(index, gcolor)}
                  >
                    {svg.popup_close}
                  </div>
                </div>
              ...
              <div
                className="pu_add_color"
                onClick={() => addDefaultGradientColor()}
              >
              ...
              <div className="pu_radio_list">
                <div className="pu_radio">
                  <input
                    ...
                    id="background_type_color"
                    value="color"
                    checked={isGradientEnable === false}
                    onChange={(e) => backgroundTypeHandle(e)}
                  />
                ...
                <div className="pu_radio">
                  <input
                    type="radio"
                    name="background_type"
                    id="background_type_gradient"
                    value="gradient"
                    checked={isGradientEnable === true}
                    onChange={(e) => backgroundTypeHandle(e)}
                  />
            ...
            {isGradientEnable === false ? (
              <div className="pu_input_wrapper">
                ...
                <div className="pu_color_picker_wrapper">
                  <div
                    className="pu_color_picker_toggle"
                    onClick={() => colorPickerOpener("bgcolor")}
                  >
                    <span className="pu_color_name">{bgColorSt}</span>
                    <span
                      className="pu_color_preview"
                      style={{ backgroundColor: bgColorSt }}
                    ></span>
                  </div>
                  <div className="pu_color_picker_dropdown">
                    <SketchPicker
                      ...
                      onChangeComplete={(color) =>
                        colorPickerComplete("bgcolor", color)
                      }
                    />
                    <HuePicker
                      color={bgColorSt}
              ...
              <>
                <div className="pu_input_wrapper_list">
                  <div className="pu_input_wrapper">
                    ...
                    <select
                      className="pu_input"
                      onChange={(e) => gradientTypeChange(e, e.target.value)}
                      value={gradientType}
                    >
                      <option value="linear">Linear</option>
                      <option value="radial">Radial</option>
                    ...
                    <div className="pu_input_wrapper">
                      ...
                      <div className="pu_mui_slider">
                        <Slider
                          ...
                          valueLabelDisplay="auto"
                          onChange={(e) =>
                            gradientAngleChange(e, e.target.value)
                          }
                          min={0}
                          max={360}
                        />
                ...
                <div className="pu_gradient_editor_wrapper">
                  ...
                  {gradientColors.map((gcolor, index) => (
                    <div key={index} className="pu_input_wrapper_list">
                      ...
                      <div className="pu_input_wrapper">
                        <div className="pu_mui_slider">
                          <Slider
                            ...
                            valueLabelDisplay="auto"
                            onChange={(e) =>
                              updateGradientStop(index, gcolor, e.target.value)
                            }
                            min={0}
                            max={100}
                          />
                      ...
                      <div
                        className="pu_remove"
                        onClick={() => removeGradientColor(index, gcolor)}
                      >
                        {svg.popup_close}
                      </div>
                    </div>
            ...
            <div className="pu_input_wrapper_list">
              <div className="pu_input_wrapper">
                ...
                <div className="pu_color_picker_wrapper">
                  <div
                    className="pu_color_picker_toggle"
                    onClick={() => colorPickerOpener("headingcolor")}
                  >
                    <span className="pu_color_name">{headingColorSt}</span>
                    <span
                      className="pu_color_preview"
                      style={{ backgroundColor: headingColorSt }}
                    ></span>
                  </div>
                  <div className="pu_color_picker_dropdown">
                    <SketchPicker
                      ...
                      onChange={(color) =>
                        colorPickerChange("headingcolor", color)
                      }
                      onChangeComplete={(color) =>
                        colorPickerComplete("headingcolor", color)
                      }
                    />
                    <HuePicker
                      color={headingColorSt}
            ...
            <div className="pu_input_wrapper_list">
              ...
              <div className="pu_input_wrapper">
                ...
                <input
                  ...
                  max="80"
                  value={headingSize}
                  onChange={(e) => headingFontSizeChange(e)}
                />
              </div>
            </div>
          </div>
            ...
            <div className="pu_input_wrapper_list">
              <div className="pu_input_wrapper">
                ...
                <div className="pu_color_picker_wrapper">
                  <div
                    className="pu_color_picker_toggle"
                    onClick={() => colorPickerOpener("textcolor")}
                  >
                    <span className="pu_color_name">{textColorSt}</span>
                    <span
                      className="pu_color_preview"
                      style={{ backgroundColor: textColorSt }}
                    ></span>
                  </div>
                  <div className="pu_color_picker_dropdown">
                    <SketchPicker
                      color={textColorSt}
                      onChange={(color) =>
                        colorPickerChange("textcolor", color)
                      }
                      onChangeComplete={(color) =>
                        colorPickerComplete("textcolor", color)
                      }
                    />
                    <HuePicker
                      color={textColorSt}
            ...
            <div className="pu_input_wrapper_list">
              ...
              <div className="pu_input_wrapper">
                ...
                <input
                  ...
                  max="80"
                  value={textSize}
                  onChange={(e) => textFontSizeChange(e)}
                />
              </div>
            </div>
          </div>
          ...
          <div className="pu_setting_theme_save">
            <button className="pu_btn" onClick={() => saveTheme()}>
              Save Theme
            </button>
          </div>
        </div>
