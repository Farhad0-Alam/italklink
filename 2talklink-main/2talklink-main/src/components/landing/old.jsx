...
const OldLandingPage = () => {
  ...
  useEffect(() => {
    dispatch(
      setPageHeading({
        ...
        keywords:
          "2TalkLink, 2TalkLink.com, pixa url, biolink, bio link, miniwebsite, mini website, social link, personal link, portfolio link, bio link generator",
        description:
  ...
  const [landTemp, setLandTemp] = useState([
    { id: 1, img: '/images/html_template_preview/1.webp' },
    { id: 2, img: '/images/html_template_preview/10.webp' },
    { id: 3, img: '/images/html_template_preview/11.webp' },
    { id: 4, img: '/images/html_template_preview/12.webp' },
    { id: 5, img: '/images/html_template_preview/12a.webp' },
    { id: 6, img: '/images/html_template_preview/13.webp' },
    { id: 7, img: '/images/html_template_preview/14.webp' },
    { id: 8, img: '/images/html_template_preview/15.webp' },
    { id: 9, img: '/images/html_template_preview/16.webp' },
    { id: 10, img: '/images/html_template_preview/16a.webp' },
    { id: 11, img: '/images/html_template_preview/17.webp' },
    { id: 12, img: '/images/html_template_preview/18.webp' },
    { id: 13, img: '/images/html_template_preview/19.webp' },
    { id: 14, img: '/images/html_template_preview/19a.webp' },
    { id: 15, img: '/images/html_template_preview/1a.webp' },
    { id: 16, img: '/images/html_template_preview/1b.webp' },
    { id: 17, img: '/images/html_template_preview/2.webp' },
    { id: 18, img: '/images/html_template_preview/20.webp' },
    { id: 19, img: '/images/html_template_preview/20a.webp' },
    { id: 20, img: '/images/html_template_preview/21.webp' },
    { id: 21, img: '/images/html_template_preview/21a.webp' },
    { id: 22, img: '/images/html_template_preview/22.webp' },
    { id: 23, img: '/images/html_template_preview/22a.webp' },
    { id: 24, img: '/images/html_template_preview/23.webp' },
    { id: 25, img: '/images/html_template_preview/23a.webp' },
    { id: 26, img: '/images/html_template_preview/24.webp' },
    { id: 27, img: '/images/html_template_preview/24a.webp' },
    { id: 28, img: '/images/html_template_preview/25.webp' },
    { id: 29, img: '/images/html_template_preview/25a.webp' },
    { id: 30, img: '/images/html_template_preview/26.webp' },
    { id: 31, img: '/images/html_template_preview/26a.webp' },
    { id: 32, img: '/images/html_template_preview/2a.webp' },
    { id: 33, img: '/images/html_template_preview/3.webp' },
    { id: 34, img: '/images/html_template_preview/4.webp' },
    { id: 35, img: '/images/html_template_preview/5.webp' },
    { id: 36, img: '/images/html_template_preview/5a.webp' },
    { id: 37, img: '/images/html_template_preview/6.webp' },
    { id: 38, img: '/images/html_template_preview/6a.webp' },
    { id: 39, img: '/images/html_template_preview/7.webp' },
    { id: 40, img: '/images/html_template_preview/7a.webp' },
    { id: 41, img: '/images/html_template_preview/8.webp' },
    { id: 42, img: '/images/html_template_preview/8a.webp' },
    { id: 43, img: '/images/html_template_preview/9.webp' }
  ]);
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage: "url('./images/landing/bg_left.png')",
          }}
        ></div>
        <div className="pu_container banner__full">
          <div className={styles.banner_content}>
            <div className={styles.banner_left}>
              ...
              <p>
                Connect and manage all your social links in one place. Organize
                your social handles into a single tap. Get a link and work
                smart.
              </p>
              <Link href="/auth/login">
        ...
        <div className="pu_container">
          <div className={styles.core_feature_content}>
            ...
            <div className={styles.core_feature_right}>
              ...
              <p>
                2TalkLink provides a single location to concentrate your
                ...
                your website or social media handles. It helps you keep in touch
                with your followers/subscribers for longer.
              </p>
              <Link href="/auth/login">
      ...
      <div
        ...
        id="stab_template"
        style={{
          backgroundImage: "url('./images/landing/template-bg.jpg')",
        }}
      >
            ...
            <div className={styles.works_left}>
              ...
              <div className={styles.works_box}>
                ...
                <div className={styles.works_box_data}>
                  <h3>Copy & Share </h3>
                  <p>
                    Tadda!!!!! You are ready to share the single link with your
                    visitors and get more engagement.{" "}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={styles.exclusive_features_main}>
            <div className={styles.features_box}>
              <div className={styles.features_box_item}>
                ...
                <p>
                  Examine your daily graph of profile visits and weekly clicks.
                </p>
              </div>
            </div>
            <div className={styles.features_box}>
            ...
            <div className={styles.features_box}>
              <div className={styles.features_box_item}>
                ...
                <p>
                  Monetize your link by connecting it to other payment apps and
                  smartly earn profits.
                </p>
              </div>
            </div>
            <div className={styles.features_box}>
      ...
      <div className={styles.footer__wr}>
        <div className="pu_container">
          <div className={styles.footer_main_box}>
            <div className={`${styles.footer_item} ${styles.footer_list_1}`}>
              ...
              <p>
                2TalkLink allows you to create a custom, personalized page that
            ...
            <div className={`${styles.footer_item} ${styles.footer_list_3}`}>
              ...
              <div className={styles.footer_info}>
                <h3>Contact No.</h3>
                <a href="tel:+13074435831">+13074435831</a>
              </div>
            </div>
            <div className={`${styles.footer_item} ${styles.footer_list_4}`}>
              ...
              <div className={styles.footer_info}>
                <h3>Whatsapp Chat</h3>
                <p>
                  <a href={`https://wa.me/${+13074435831}`}>
                    Click Here to Chat
                  </a>
                </p>
              </div>
        ...
        <footer className="ecardURLFooter">
          <div className="ecardURLFooterWrapper">
            <div className="ecardURLFooterLinks">
              <span>
                <a href="/privacy-and-policy" className="ecardURLFooterLink">
                  Privacy Policy
                </a>
              </span>
              <span>
                <a href="/terms-of-service" className="ecardURLFooterLink">
                  Terms of Service
                </a>
              </span>
            </div>
            <div className="ecardURLFooterCopyright">
              <p>
                Copyright © {new Date().getFullYear()} 2TalkLink. All rights
                reserved.
              </p>
            </div>
          </div>
